...
#   https://github.com/alexandrovteam/pyimzML/blob/master/pyimzml/ontology/dump_obo_files.py
...
ontology_sources = [
    ("_ms", "https://raw.githubusercontent.com/HUPO-PSI/psi-ms-CV/master/psi-ms.obo", ["MS"]),
    ("_uo", "https://raw.githubusercontent.com/bio-ontology-research-group/unit-ontology/master/unit.obo", ["UO"]),
    (
        "_ims",
        "https://raw.githubusercontent.com/imzML/imzML/f2c8b6ce2affa8d8eef74d4bfe5922c815ff4dff/imagingMS.obo",
        ["IMS"],
    ),
]
...
if __name__ == "__main__":
    ...
    for ontology_name, src, namespaces in ontology_sources:
        ...
        with open(f"./imzy/_readers/imzml/{ontology_name}.py", "wt") as f:
